...
const IndexPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Explore Cars - Your Ultimate Car Marketplace</title>
        <meta
          name="description"
          content="Explore the latest and greatest cars from top brands. Find your dream car now!"
        />
        <meta name="robots" content="index, follow" />
        <meta
          property="og:title"
          content="Explore Cars - Your Ultimate Car Marketplace"
        />
        <meta
